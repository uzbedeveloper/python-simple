    ...
    try:
        while True:
            if Date_Time_Userbot_teletips.is_connected:
                ...
                Image_font_teletips2 = ImageFont.truetype("ds-digit.ttf", 250)
                ...
                Image_edit_teletips.text((690, 800), Image_text_teletips2, (3,160,98), font = Image_font_teletips2)
                Image_teletips.save("Image_final_teletips.jpg")
                await Date_Time_Userbot_teletips.update_profile(bio = f"📅Today is: {Date_teletips}" , last_name = f" ")
